...
class CourseInstructorsControllerTest < ActionController::TestCase
  ...
  test "should create course_instructor" do
    assert_difference('CourseInstructor.count') do
      post :create, course_instructor: { course_id: @course_instructor.course_id, enddate: @course_instructor.enddate, startdate: @course_instructor.startdate, status: @course_instructor.status, user_id: @course_instructor.user_id }
    end
  ...
  test "should update course_instructor" do
    patch :update, id: @course_instructor, course_instructor: { course_id: @course_instructor.course_id, enddate: @course_instructor.enddate, startdate: @course_instructor.startdate, status: @course_instructor.status, user_id: @course_instructor.user_id }
    assert_redirected_to course_instructor_path(assigns(:course_instructor))
  end
